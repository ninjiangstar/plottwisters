...
const giftTags = {
    tags: [
       ...
       },
       {
          name: "Patience",
          alias: "The Key",
          description: "You held open the door for people, even if they were a bit far away.",
       },
       {
          name: "Persistence",
          alias: "Short Order",
...
export class GiftTaggerApp extends React.PureComponent<{}> {
    ...
    private renderGiftTag = (tag: { name: string; alias: string; description?: string; }, i: number) => {
        return (
