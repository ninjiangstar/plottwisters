...
import { getDataPoints, getDomain, getMillis, getRange, getTimestamp } from "../../common/utils";
...
const mapDataPointsToPixels = (dataPoints: IDataPoint[], domainRange: IDomainRange): IDataPoint[] => {
    ...
    return (
        <div>
            ...
            <svg width={TIMELINE_WIDTH} height={TIMELINE_HEIGHT}>
                <g>
                    {dataPoints.map(renderDataPoint(height))}
                </g>
            </svg>
        </div>
    );
